...
<body>
    ...
    <section id="statistik" class="bg-light py-5">
        <div class="container">
            <h2 class="text-center">Statistik Manajemen Aset</h2>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="https://salam.uinsgd.ac.id/dashboard/login.php" class="text-black">Sistem Informasi Layanan Akademik (SALAM)</a></li>
                        <li><a href="https://eknows.uinsgd.ac.id/login/index.php" class="text-black">Learning Management Sistem (LMS)</a></li>
                        <li><a href="https://lib.uinsgd.ac.id/download/" class="text-black">E-Library UIN Sunan Gunung Djati</a></li>
                        <li><a href="https://join.if.uinsgd.ac.id/index.php/join" class="text-black">Jurnal Online Informatika</a></li>
                    </ul>
                </div>
                <!-- Kolom Akses Cepat -->
                <div class="col-md-3">
                    <h5>Akses Cepat</h5>
                    <ul class="list-unstyled">
                        <li><a href="https://fst.uinsgd.ac.id/" class="text-black">Fakultas Sains dan Teknologi</a></li>
                        <li><a href="https://uinsgd.ac.id/" class="text-black">UIN Sunan Gunung Djati</a></li>
                        <li><a href="https://sinta.kemdikbud.go.id/" class="text-black">SINTA Dikti Kemendikbud RI</a></li>
                        <li><a href="https://pddikti.kemdiktisaintek.go.id/" class="text-black">Pangkalan Data DIKTI Kemendikbud RI</a></li>
                    </ul>
                </div>
            </div>
            <hr class="my-3">
